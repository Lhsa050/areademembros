    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="<?= url('/products') ?>" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-teal-50 border border-teal-200 rounded-lg p-4">
                ...
                <p class="text-xs text-teal-600 mt-1">Informe o <strong>product_id</strong> ou <strong>SKU</strong> deste produto na CartPanda. Usado pelo webhook unificado para identificar automaticamente qual produto foi comprado.</p>
            </div>
